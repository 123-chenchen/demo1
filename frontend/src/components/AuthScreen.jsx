  ...
  return (
    <div className="min-h-screen bg-zinc-100 text-zinc-950">
      <main className="flex min-h-screen w-full items-center justify-center px-4 py-8">
        <section className="w-full max-w-md rounded-lg border border-zinc-200 bg-white p-5 shadow-soft sm:p-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-teal-700 lg:hidden">
                  PDF Chatbot
                </p>
